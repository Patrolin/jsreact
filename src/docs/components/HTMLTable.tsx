...
/* NOTE: styled by .css, NOTE: Proof of concept FlexTable without slow MUI components */
export const HTMLTable = <T,>(props: Props<T>): React.ReactNode => {
  const {
    toolbar,
    columns,
    rows,
  ...
  return (
    <div id={tableId} style={style} className="flex-table" data-centered={centered}>
